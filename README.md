...
|             client-cert              |          2231           |     sa      |      -      | [rsa private key](/client-cert/user-key)<br/>[ed25519 private key](/client-cert/user-key_ed25519)<br/>[ecdsa private key](/client-cert/user-key_ecdsa-sha2-nistp256)<br/>[certificate (rsa only)](https://github.com/termius/hosts-farm/blob/master/client-cert/user-key-cert.pub) |
