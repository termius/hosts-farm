...
|                 otp                  |          2205           |     sa      |      -      |                                                                                     [README](/otp/README.md) <br/>[keys](/otp/keys.txt)                                                                                      |
...
|             client-cert              |          2231           |     sa      |      -      | rsa [key](/client-cert/user-key), [cert](https://github.com/termius/hosts-farm/blob/master/client-cert/user-key-cert.pub)<br/>ed25519 [key](/client-cert/user-key_ed25519), [cert](https://github.com/termius/hosts-farm/blob/master/client-cert/user-key_ed25519-cert.pub)<br/>ecdsa [key](/client-cert/user-key_ecdsa-sha2-nistp256), [cert](https://github.com/termius/hosts-farm/blob/master/client-cert/user-key_ecdsa-sha2-nistp256-cert.pub)|
...
|               pass-otp               |          2258           |     sa      |    pass     |                                                                        [README](/otp/README.md) <br/>[keys](/otp/keys.txt)                                                                                      |
